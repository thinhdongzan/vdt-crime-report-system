...
import com.crimereport.auth.infrastructure.security.CustomUserPrincipal;
...
public class JwtService {
    ...
    @Value("${jwt.secret:supersecretkeyforthecrimereportsystem1234567890}")
    ...
    public String generateToken(Map<String, Object> extraClaims, User user) {
        ...
        extraClaims.put("role", user.getRoleCode().name());
        extraClaims.put("email", user.getEmail());
        extraClaims.put("phone", user.getPhone());
        extraClaims.put("fullName", user.getFullName());
        extraClaims.put("unitId", user.getUnitId());
